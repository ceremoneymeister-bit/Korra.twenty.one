...
# ``korra_cli/plugins.py:10-12``.  The guard only checked the bundled
...
# this script runs as a standalone subprocess — ``korra_constants`` isn't
...
def main() -> int:
    ...
    # Add repo root to sys.path so we can import korra_constants (this script
