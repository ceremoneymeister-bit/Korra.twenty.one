...
# Configuration
# Korra: жёсткий форк. Раньше этот скрипт ставил клиенту движок Nous, а не наш.
# Репозиторий ПРИВАТНЫЙ: этот путь установки — для нас, клиентская раскатка
# идёт готовым образом из registry, а не сборкой из исходников.
REPO_URL_SSH="git@github.com:ceremoneymeister-bit/Korra.twenty.one.git"
REPO_URL_HTTPS="https://github.com/ceremoneymeister-bit/Korra.twenty.one.git"
