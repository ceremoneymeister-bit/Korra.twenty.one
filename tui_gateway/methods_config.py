...
def _(rid, params: dict) -> dict:
    ...
    if key == "provider":
        try:
            from korra_cli.models import list_available_providers, normalize_provider
        ...
        if (
            ...
            return _ok(
                rid,
                {
                    ...
                    "source": source,
                    "error": "No Korra provider is configured.",
                },
            )
...
def _(rid, params: dict) -> dict:
    ...
    try:
        ...
        from korra_cli.diagnostics_upload import share_to_nous
