...
from korra_cli.timeouts import (
...
# (korra_state._rows_to_conversation), so any code that mutates a loaded or
...
class AIAgent:
    ...
    def _ensure_lmstudio_runtime_loaded(
        ...
        from korra_cli.models import ensure_lmstudio_model_loaded
    ...
    def _invoke_api_request_error_hook(
        ...
        *,
        ...
        try:
            from korra_cli import lifecycle as _lifecycle
    ...
    def _try_refresh_env_client_credentials(self) -> bool:
        ...
        if (
            ...
            if self.provider == "kimi-coding":
                from korra_cli.auth import _resolve_kimi_base_url

                base_url = _resolve_kimi_base_url(
                    api_key, pconfig.inference_base_url, env_url
                ).rstrip("/")
            elif self.provider == "zai":
                from korra_cli.auth import _resolve_zai_base_url
    ...
    def _supports_reasoning_extra_body(self) -> bool:
        ...
        if (
            ...
            try:
                from korra_cli.models import github_model_reasoning_efforts
    ...
    def _lmstudio_reasoning_options_cached(self) -> list[str]:
        ...
        if cached is not None:
            ...
            if opts or (_time.monotonic() - ts) < 60:
                return opts
        try:
            from korra_cli.models import lmstudio_model_reasoning_options
    ...
    def _ollama_supports_thinking_cached(self) -> bool:
        ...
        try:
            from korra_cli.models import ollama_model_supports_thinking
    ...
    def _compress_context(
        ...
        *,
        ...
        try:
            ...
            # id rotation updated korra_logging._session_context (a
    ...
    def run_conversation(
        ...
        from korra_cli.observability.relay_shared_metrics import (
            finish_task_run,
            start_task_run,
        )
