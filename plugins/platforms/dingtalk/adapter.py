...
# dict in korra_cli/gateway.py, and the _send_dingtalk dispatch in
...
def interactive_setup() -> None:
    ...
    Replaces korra_cli/setup.py-era _setup_dingtalk + the static
    _PLATFORMS["dingtalk"] dict in korra_cli/gateway.py. CLI helpers are
    ...
    if method == 0:
        try:
            from korra_cli.dingtalk_auth import dingtalk_qr_auth
