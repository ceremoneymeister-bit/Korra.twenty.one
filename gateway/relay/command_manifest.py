...
def build_relay_command_manifest() -> List[Dict[str, Any]]:
    ...
    return [
        ...
        {"name": "reset", "description": "Reset your Korra session"},
        {
            "name": "model",
        ...
        {"name": "status", "description": "Show Korra session status"},
        {"name": "sethome", "description": "Set this chat as the home channel"},
        {"name": "stop", "description": "Stop the running Korra agent"},
        {
            "name": "steer",
        ...
        {"name": "update", "description": "Update Korra to the latest version"},
        {"name": "restart", "description": "Gracefully restart the Korra gateway"},
        {
            "name": "approve",
        ...
        {
            "name": "thread",
            "description": "Create a new thread and start a Korra session in it",
