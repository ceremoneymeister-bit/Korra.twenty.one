...
from korra_cli.config import atomic_config_write, cfg_get, clear_model_endpoint_credentials
from utils import (
    atomic_json_write,
...
class GatewaySlashCommandsMixin:
    ...
    async def _handle_reset_command(self, event: MessageEvent) -> Union[str, EphemeralReply]:
        ...
        try:
            from korra_cli.tips import get_random_tip
    ...
    async def _handle_model_command(self, event: MessageEvent) -> Optional[str]:
        ...
        from korra_cli.providers import get_label
        ...
        # via the shared single-owner parser (korra_cli.model_switch).
            ...
            if has_picker:
                ...
                if providers:
                    ...
                    async def _on_model_selected_scoped(
                        ...
                        try:
                            from korra_cli.context_switch_guard import (
                        ...
                        from korra_cli.model_switch import format_model_for_display
                        ...
                        from korra_cli.model_switch import resolve_display_context_length_async
                        _sw_config_ctx = None
                        _sw_model_cfg = {}
                        try:
    ...
    async def _handle_codex_runtime_command(self, event: MessageEvent) -> str:
        ...
        from korra_cli import codex_runtime_switch as crs
    ...
    async def _handle_personality_command(self, event: MessageEvent) -> str:
        ...
        # Persist the selection only — korra_cli.personality never writes
    ...
    async def _handle_heartbeat_command(self, event: "MessageEvent") -> str:
        ...
        """
        from korra_cli.heartbeat import parse_interval, format_interval, MIN_INTERVAL_SECONDS
    ...
    async def _handle_fast_command(self, event: MessageEvent) -> Optional[str]:
        ...
        from korra_cli.models import model_supports_fast_mode
    ...
    async def _handle_branch_command(self, event: MessageEvent) -> str:
        ...
        try:
            await self._session_db.create_session(
                ...
                # path (korra_state.py:1994-2009) that searches by the complete
    ...
    async def _handle_update_command(self, event: MessageEvent) -> str:
        ...
        if is_managed():
            return f"✗ {format_managed_message('update Korra')}"
