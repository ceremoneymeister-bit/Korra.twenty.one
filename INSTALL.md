...
Preflight требует не менее 2 CPU, 1536 МиБ видимой RAM и 16 ГиБ свободного
места; 4 vCPU / 8 ГБ / 60 ГБ из сценария A остаются рекомендацией для
нескольких активных профилей. На меньшей машине переходите к сценарию B.
