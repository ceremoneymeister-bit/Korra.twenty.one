export type ParentWatchdogEnv = {
  ...
  /** Spawn tag consumed by korra_cli.process_identity (`v1:<install>:<purpose>:<spawner_pid>:<spawner_create_s>`).
...
/** Build the `HERMES_SPAWN` tag mirrored by korra_cli/process_identity.py.
