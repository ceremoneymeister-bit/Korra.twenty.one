 ...
 * пишет правило в постоянный allowlist — промах мышью там навсегда снимает
 * вопрос с целого класса команд. Остальным ответам вторая кнопка была бы
 * трением: агент стоит и ждёт.
 */
...
const CHOICE_META: Record<ApprovalChoiceValue, ChoiceMeta> = {
  ...
  always: {
    ...
    hint: "Правило запишется навсегда — снимает вопрос и в будущих чатах",
    icon: InfinityIcon,
    confirm: true,
  },
  deny: {
