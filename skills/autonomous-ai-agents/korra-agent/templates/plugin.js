/**
 * Korra desktop plugin template. Save as:
 *   $HERMES_HOME/desktop-plugins/<id>/plugin.js   (folder name == id)
 * where $HERMES_HOME is the data home, and points at .../profiles/<name>
 * when running a named profile (`korra -p <name>`). Run `korra doctor` (or
