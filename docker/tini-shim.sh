...
INIT_TARGET="${KORRA_TINI_SHIM_TARGET:-${HERMES_TINI_SHIM_TARGET:-/init}}"
WRAPPER="${KORRA_TINI_SHIM_WRAPPER:-${HERMES_TINI_SHIM_WRAPPER:-/opt/hermes/docker/main-wrapper.sh}}"
