...
_CATALOGUE = {
    ...
    "korra.secretary": {
        ...
        "name": "Секретарь",
        "description": "Заметки, письма, рабочие договорённости и план дня.",
        "requirements": [
            "Для начала нужна подключённая чат-модель. Можно сразу принести заметки, письмо или документ.",
            "Календарь и почту подключают по необходимости в «Ключах и доступах». Для уведомлений нужен настроенный канал доставки.",
