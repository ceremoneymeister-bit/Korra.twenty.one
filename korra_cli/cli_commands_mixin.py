...
from korra_constants import display_hermes_home, is_termux as _is_termux_environment, korra_env
...
class CLICommandsMixin:
    ...
    def _handle_export_command(self, command: str):
        ...
        """
        from korra_cli.profiles import export_profile, get_active_profile_name
    ...
    def _handle_journey_command(self, cmd_original: str) -> None:
        ...
        from cli import _cprint
        from korra_cli.journey import register_cli
    ...
    def _handle_paste_command(self):
        ...
        from korra_cli.clipboard import has_clipboard_image
    ...
    def _handle_copy_command(self, cmd_original: str) -> None:
        ...
        try:
            from korra_cli.clipboard import (
    ...
    def _handle_tools_command(self, cmd: str):
        ...
        def _run_capture(ns: Namespace) -> None:
            ...
            # Buffer reports isatty()=True so color() in korra_cli/colors.py
    ...
    def _handle_profile_command(self):
        ...
        from korra_cli.slash_exec import CommandContext, execute_command
    ...
    def _handle_resume_command(self, cmd_original: str) -> None:
        ...
        if target.isdigit():
            ...
            from korra_cli.main import _resolve_session_by_name_or_id
    ...
    def _handle_worktree_command(self, cmd_original: str) -> None:
        ...
        (korra_cli/worktree_gc.py): never deletes tracked changes, unique
    ...
    def _handle_personality_command(self, cmd: str):
        ...
        All resolution/persistence goes through korra_cli.personality —
        ...
        if len(parts) > 1:
            ...
            if not name:
                ...
                try:
                    from korra_cli.config import cfg_get, read_raw_config
    ...
    def _handle_pet_command(self, cmd: str):
        ...
        from korra_cli.pets import _set_active, _set_enabled, print_pet_gallery, set_pet_scale, toggle_pet_display
    ...
    def _handle_hatch_command(self, cmd: str):
        ...
        from korra_cli.pets import _set_active
    ...
    def _handle_curator_command(self, cmd: str):
        ...
        Delegates to korra_cli.curator so the CLI and the `hermes curator`
    ...
    def _handle_kanban_command(self, cmd: str):
        ...
        """
        from korra_cli.kanban import run_slash
    ...
    def _handle_skills_command(self, cmd: str):
        """Handle /skills slash command — delegates to korra_cli.skills_hub."""
        ...
        if args and args[0].lower() in {"pending", "approve", "apply", "reject",
            ...
            if out is not None:
                print(out)
                return
        from korra_cli.skills_hub import handle_skills_slash
    ...
    def _handle_background_command(self, cmd: str):
        ...
        def run_background():
            ...
            try:
                ...
                if response:
                    try:
                        from korra_cli.skin_engine import get_active_skin
                        _skin = get_active_skin()
                        label = _skin.get_branding("response_label", "⚕ Korra")
        ...
        if sub.startswith("connect"):
            ...
            if hasattr(self, '_pending_input'):
                self._pending_input.put(
                    ...
                    "just because CDP is connected. This is typically a Korra-managed isolated debug "
    ...
    def _handle_heartbeat_command(self, cmd: str) -> None:
        ...
        from korra_cli.heartbeat import parse_interval, format_interval
    ...
    def _handle_goal_command(self, cmd: str) -> None:
        ...
        from korra_cli.goals import parse_contract
    ...
    def _handle_focus_command(self, cmd_original: str) -> None:
        ...
        from korra_cli.colors import Colors as _Colors
    ...
    def _set_tool_progress_mode(self, mode: str) -> None:
        ...
        """
        from korra_cli.focus_view import normalize_tool_progress_mode
    ...
    def _note_focus_hidden_line(self, function_name: str) -> None:
        ...
        if not getattr(self, "_focus_view_enabled", False):
            return
        from korra_cli.focus_view import would_display_tool_line
    ...
    def _emit_focus_recovery_line(self) -> None:
        ...
        if not getattr(self, "_focus_view_enabled", False):
            return
        from korra_cli.focus_view import format_hidden_line
    ...
    def _handle_approvals_command(self, cmd_original: str) -> None:
        ...
        from cli import _cprint
        from korra_cli.approval_mode import run_approval_mode_command
    ...
    def _handle_busy_command(self, cmd: str):
        ...
        if save_config_value("display.busy_input_mode", arg):
            if arg == "queue":
                behavior = "Enter will queue follow-up input while Korra is busy."
            elif arg == "steer":
    ...
    def _handle_indicator_command(self, cmd: str):
        ...
        """
        from cli import _ACCENT, _DIM, _RST, _cprint, save_config_value
        from korra_constants import DEFAULT_INDICATOR_STYLE, INDICATOR_STYLES
    ...
    def _handle_fast_command(self, cmd: str):
        ...
        try:
            from korra_cli.models import _is_anthropic_fast_model
            agent = getattr(self, "agent", None)
    ...
    def _handle_update_command(self) -> bool:
        ...
        choices = [
            ("once", "Update Now", "exit the current session and update Korra"),
