...
.. code-block:: python
    ...
    from korra_cli.skin_engine import get_active_skin, list_skins, set_active_skin
...
_BUILTIN_SKINS: Dict[str, Dict[str, Any]] = {
    "default": {
        "name": "default",
        "description": "Classic Korra — gold and kawaii",
        ...
        "branding": {
            "agent_name": "Korra",
            "welcome": "Welcome to Korra! Type your message or /help for commands.",
            "goodbye": "Goodbye! ⚕",
            "response_label": " ⚕ Korra ",
            "prompt_symbol": "❯",
