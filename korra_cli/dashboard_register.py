...
def _resolve_portal_base_url(override: Optional[str] = None) -> str:
    ...
    try:
        from korra_cli.auth import DEFAULT_NOUS_PORTAL_URL, get_provider_auth_state
...
def cmd_dashboard_register(args) -> None:
    ...
    from korra_cli.config import get_env_value, is_managed, save_env_value
    ...
    portal_override = getattr(args, "portal_url", None) or korra_env(
