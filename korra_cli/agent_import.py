...
def import_agent_command(args) -> None:
    """Handle ``hermes import-agent`` (invoked from korra_cli.main)."""
    from korra_cli.config import get_config_path, load_config, save_config
...
def print_import_report(report: Dict[str, Any], dry_run: bool) -> None:
    ...
    from korra_cli.setup import Colors, color, print_header, print_info
