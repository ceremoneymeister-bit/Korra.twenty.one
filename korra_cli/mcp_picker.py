...
from korra_cli.cli_output import prompt_yes_no
from korra_cli.curses_ui import curses_single_select
from korra_cli.mcp_catalog import (
    CatalogEntry,
    CatalogError,
    catalog_diagnostics,
    install_entry,
...
def _enable_disable(name: str, *, enable: bool) -> None:
    ...
    print(color(
        ...
        "Start a new Korra session for changes to take effect.",
        Colors.GREEN,
    ))
