...
* This module intentionally mirrors ``korra_cli/goals.py`` — same aux
...
HERMES_KANBAN_SPECIFY_MAX_TOKENS = max(
    1500,
    env_int("KORRA_KANBAN_SPECIFY_MAX_TOKENS", 6000),
)
...
def _profile_author() -> str:
    """Mirror of ``korra_cli.kanban._profile_author``. Kept local to
