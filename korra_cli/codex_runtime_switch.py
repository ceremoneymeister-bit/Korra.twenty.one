...
The actual runtime resolution happens in korra_cli.runtime_provider's
...
def apply(
    ...
    *,
    ...
    if new_value == "codex_app_server":
        ...
        try:
            from korra_cli.codex_runtime_plugin_migration import migrate
            ...
            if "hermes-tools" in mig_report.migrated:
                msg_lines.append(
                    "Korra tool callback registered: codex can now use "
                ...
                msg_lines.append(
                    ...
                    "only on the default Korra runtime — they need the "
                    "agent loop context.)"
                )
        ...
        msg_lines.append(
            ...
            "Korra tools available via MCP callback)."
        )
        msg_lines.append(
        ...
        msg_lines.append("OpenAI/Codex turns will use the default Korra runtime.")
