...
class TestLoadMCPConfig:
    ...
    def test_valid_config_parsed(self):
        ...
        with patch("korra_cli.config.load_config", return_value={"mcp_servers": servers}):
    ...
    def test_mcp_servers_not_dict_returns_empty(self):
        ...
        with patch("korra_cli.config.load_config", return_value={"mcp_servers": "invalid"}):
            from tools.mcp_tool import _load_mcp_config
            result = _load_mcp_config()
            assert result == {}
    ...
    def test_portable_servers_merge_after_native_interpolation(self):
        ...
        with (
            patch("korra_cli.config.load_config", return_value={"mcp_servers": native}),
            patch("korra_cli.plugins.discover_plugins"),
            patch("korra_cli.plugins.get_plugin_manager", return_value=manager),
...
class TestBuildSafeEnv:
    ...
    def test_secret_source_injected_vars_are_passed(self, monkeypatch):
        ...
        from korra_cli import env_loader
        from tools.mcp_tool import _build_safe_env
