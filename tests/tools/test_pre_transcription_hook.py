...
def _fake_hooks(monkeypatch, results):
    ...
    monkeypatch.setattr("korra_cli.plugins.invoke_hook", _invoke)
    return captured
...
def _no_hooks(monkeypatch):
    ...
    monkeypatch.setattr("korra_cli.plugins.has_hook", lambda name: False)
    monkeypatch.setattr("korra_cli.plugins.invoke_hook", _boom)
