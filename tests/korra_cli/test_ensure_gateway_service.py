"""Tests for korra_cli.gateway.ensure_gateway_service — the zero-prompt
...
def _patch_host(monkeypatch, *, container=False, systemd=True, macos=False, windows=False):
    monkeypatch.setattr("korra_constants.is_container", lambda: container)
