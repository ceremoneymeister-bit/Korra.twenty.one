"""Tests for kanban board export / import (``korra_cli.kanban_transfer``).
...
from korra_cli import kanban_transfer as kt
from korra_cli.archive_safe import normalize_archive_parts, safe_extract_targz
...
def test_import_rejects_a_future_format_version(kanban_root, tmp_path):
    ...
    kanban_root("target")
    with pytest.raises(ValueError, match="newer than this Korra"):
