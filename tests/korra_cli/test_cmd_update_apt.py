...
from korra_cli.main import _cmd_update_check, cmd_update


def test_apt_stamp_is_detected_and_recommends_pkg_upgrade(tmp_path):
    from korra_cli.config import detect_install_method, recommended_update_command_for_method
...
@patch("korra_cli.config.detect_install_method", return_value="apt")
