...
class TestGmiAliases:
    ...
    def test_providers_normalize_provider(self):
        from korra_cli.providers import normalize_provider as normalize_provider_in_providers
...
class TestGmiDoctor:
    def test_provider_env_hints_include_gmi(self):
        from korra_cli.doctor import _PROVIDER_ENV_HINTS
    ...
    def test_run_doctor_checks_gmi_models_endpoint(self, monkeypatch, tmp_path):
        ...
        try:
            from korra_cli import auth as _auth_mod
...
class TestGmiMainFlow:
    def test_chat_parser_accepts_gmi_provider(self, monkeypatch):
        ...
        monkeypatch.setattr("korra_cli.config.get_container_exec_info", lambda: None)
        monkeypatch.setattr(
            "korra_cli.main.cmd_chat",
    ...
    def test_select_provider_and_model_routes_gmi_to_generic_flow(self, monkeypatch):
        ...
        monkeypatch.setattr("korra_cli.auth.resolve_provider", lambda *args, **kwargs: None)
        ...
        monkeypatch.setattr("korra_cli.main._model_flow_api_key_provider", fake_model_flow_api_key_provider)
    ...
    def test_model_flow_api_key_provider_persists_gmi_selection(self, monkeypatch):
        ...
        with patch(
            ...
            from korra_cli.main import _model_flow_api_key_provider
