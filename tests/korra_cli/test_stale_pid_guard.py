...
- ``korra_cli/_subprocess_compat.pid_is_hermes`` / ``kill_process_tree``
- ``korra_cli/dashboard_procs._kill_stale_dashboard_processes`` (win32)
- ``korra_cli/update_cmd._stop_process_trees``
...
from korra_cli import _subprocess_compat
from korra_cli import dashboard_procs
...
class TestPidIsHermes:
    ...
    def test_hermes_match_requires_token_boundary(self):
        ...
        assert _subprocess_compat._text_names_hermes(
            r"C:\Users\x\.hermes-runtime\python.exe -m korra_cli.main"
        ) is True
        assert _subprocess_compat._text_names_hermes(
...
class TestStopProcessTrees:
    ...
    def test_foreign_pids_only_probed(self):
        with mock.patch(
            ...
            "korra_cli._subprocess_compat.pid_is_hermes", return_value=False
    ...
    def test_hermes_pid_probed_then_taskkilled(self):
        with mock.patch(
            ...
            "korra_cli._subprocess_compat.pid_is_hermes", return_value=True
        ), mock.patch.object(
