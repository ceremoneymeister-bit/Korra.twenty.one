...
``korra_cli.main`` skips eager plugin discovery at argparse-setup time
...
from korra_cli._parser import build_top_level_parser, top_level_value_flag_sets
...
def _live_subcommand_names() -> set[str]:
    ...
    built-in-only set.
    """
    from korra_cli import main as _main
