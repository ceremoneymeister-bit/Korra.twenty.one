"""Tests for the shared byte formatter (korra_cli.sizefmt).
...
def test_migrated_sites_render_through_the_shared_helper():
    ...
    from korra_cli.backup import _format_size as backup
    from korra_cli.checkpoints import _fmt_bytes as checkpoints
    from korra_cli.doctor import _human_bytes as doctor
