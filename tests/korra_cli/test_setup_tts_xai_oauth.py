...
def test_run_xai_oauth_login_from_setup_does_not_hijack_active_provider(
    ...
    monkeypatch.setattr("korra_cli.auth._is_remote_session", lambda: True)

    from korra_cli.auth import is_source_suppressed, suppress_credential_source
    from korra_cli.setup import _run_xai_oauth_login_from_setup
