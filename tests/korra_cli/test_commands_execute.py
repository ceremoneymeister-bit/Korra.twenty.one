...
Every ``CommandDef`` with ``execute`` set must:
  * name a key that exists in :data:`korra_cli.slash_exec.EXECUTORS`, and
...
from korra_cli.commands import COMMAND_REGISTRY, resolve_command
from korra_cli.slash_exec import (
    EXECUTORS,
    CommandContext,
    CommandReply,
    execute_command,
