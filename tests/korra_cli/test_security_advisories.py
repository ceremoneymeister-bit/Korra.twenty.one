"""Tests for korra_cli.security_advisories.
...
import korra_cli.security_advisories as adv
...
class TestAck:
    ...
    def test_ack_advisory_persists_id(self, isolated_home, monkeypatch):
        ...
        # don't depend on the full korra_cli.config bootstrap.
        store: dict = {"security": {}}
        monkeypatch.setattr(
            "korra_cli.config.load_config", lambda: store
        )
        monkeypatch.setattr(
