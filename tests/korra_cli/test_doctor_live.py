...
from korra_cli import doctor_live
from korra_cli.doctor_live import (
    ProbeResult,
...
class TestBrowserAvailableNpxRung:
    ...
    def _block_path_and_node_modules_checks(self, monkeypatch, tmp_path):
        ...
        monkeypatch.setattr("korra_cli.doctor.HERMES_HOME", tmp_path / "home")
        monkeypatch.setattr("korra_cli.doctor.PROJECT_ROOT", tmp_path / "root")
