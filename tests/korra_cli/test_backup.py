...
def _advance_backup_clock(seconds: float = 1.1) -> None:
    """Skew korra_cli.backup's datetime forward instead of sleeping.
    ...
    import korra_cli.backup as _backup
...
class TestShouldExclude:
    def test_excludes_hermes_agent(self):
        from korra_cli.backup import _should_exclude
    ...
    def test_excludes_state_snapshots_dir(self):
        ...
        from korra_cli.backup import _EXCLUDED_DIRS, _QUICK_SNAPSHOTS_DIR, _should_exclude
...
class TestBackup:
    ...
    def test_state_snapshots_not_nested_into_backup(self, tmp_path, monkeypatch):
        ...
        from korra_cli.backup import _QUICK_SNAPSHOTS_DIR, create_quick_snapshot, run_backup
...
class TestValidateBackupZip:
    ...
    def test_state_db_passes(self, tmp_path):
        ...
        from korra_cli.backup import _validate_backup_zip
...
class TestRoundTrip:
    def test_backup_then_import(self, tmp_path, monkeypatch):
        ...
        from korra_cli.backup import run_backup, run_import
...
class TestValidation:
    ...
    def test_detect_prefix_only_dirs(self):
        ...
        import io
        from korra_cli.backup import _detect_prefix
...
class TestSafeCopyDb:
    def test_copies_valid_database(self, tmp_path):
        from korra_cli.backup import _safe_copy_db
    ...
    def test_aborts_when_source_remains_busy_past_deadline(
        ...
        from korra_cli import backup as backup_mod
...
class TestQuickSnapshot:
    ...
    def test_state_db_safely_copied(self, hermes_home):
        from korra_cli.backup import create_quick_snapshot
        snap_id = create_quick_snapshot(hermes_home=hermes_home)
    ...
    def test_restore_state_db_live_connection(self, hermes_home):
        ...
        """
        from korra_cli.backup import create_quick_snapshot, restore_quick_snapshot
        snap_id = create_quick_snapshot(hermes_home=hermes_home)
...
# ---------------------------------------------------------------------------
    ...
    def test_oversized_db_suppresses_pruning(self, hermes_home, capsys):
        ...
        """
        import json
        from korra_cli.backup import create_quick_snapshot, list_quick_snapshots
...
class TestRunPreUpdateBackup:
    ...
    def test_config_off_disables_everything_silently(self, hermes_home, capsys):
        ...
        from korra_cli.main import _run_pre_update_backup
...
class TestPreMigrationBackup:
    ...
    def test_restorable_with_hermes_import(self, hermes_home, tmp_path):
        ...
        from korra_cli.backup import create_pre_migration_backup, _validate_backup_zip
    ...
    def test_does_not_touch_pre_update_backups(self, hermes_home):
        ...
        from korra_cli.backup import create_pre_update_backup, create_pre_migration_backup
