...
from korra_cli.web_server import MoaConfigPayload, MoaModelSlot, MoaPresetPayload, set_moa_models
...
class TestSetMoaModelsPreservesUndeclaredKeys:
    ...
    def test_save_traces_preserved(self, tmp_path):
        ...
        with (
            patch("korra_cli.web_server.load_config", side_effect=fake_load_config),
            patch("korra_cli.web_server.save_config", side_effect=fake_save_config),
            patch("korra_cli.web_server._profile_scope"),
        ):
