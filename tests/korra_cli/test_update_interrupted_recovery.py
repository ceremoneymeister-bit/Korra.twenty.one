...
def _stub_install_env(monkeypatch, m, seen):
    ...
    monkeypatch.setattr("korra_cli.managed_uv.ensure_uv", lambda: None)
    # The install executor moved to korra_cli._install_repair (shared between
    ...
    import korra_cli._install_repair as ir
