"""Fixtures shared across korra_cli kanban tests."""
...
def _suppress_concurrent_hermes_gate(request, monkeypatch):
    ...
    if request.node.get_closest_marker("real_concurrent_gate"):
        return
    try:
        from korra_cli import main as _cli_main
    except Exception:
        return
    # raising=False: under pytest's per-test spawn isolation, a concurrent
    # xdist worker importing a module that transitively touches korra_cli.main
