...
def test_exhausted_pool_provider_is_not_authenticated(monkeypatch):
    ...
    from korra_cli.model_switch import get_authenticated_provider_slugs
...
def test_opaque_legacy_pool_value_stays_visible(monkeypatch):
    ...
    from korra_cli.model_switch import _credential_pool_is_usable
