...
from korra_cli.models import get_copilot_model_context
...
class TestGetCopilotModelContext:
    ...
    @patch("korra_cli.models.fetch_github_model_catalog", return_value=_SAMPLE_CATALOG)
    ...
    @patch("korra_cli.models._urlopen_model_catalog_request")
    ...
    @patch("korra_cli.models.fetch_github_model_catalog", return_value=[])
