...
def test_healthy_bundle_passes(monkeypatch):
    ...
    for key in ("KORRA_CA_BUNDLE", "HERMES_CA_BUNDLE", "SSL_CERT_FILE",
...
# Оба имени пары проверяются: сообщение обязано называть ту переменную,
# которую оператор действительно выставил.
@pytest.mark.parametrize(
    "env_var",
    ["KORRA_CA_BUNDLE", "HERMES_CA_BUNDLE", "SSL_CERT_FILE", "REQUESTS_CA_BUNDLE", "CURL_CA_BUNDLE"],
)
