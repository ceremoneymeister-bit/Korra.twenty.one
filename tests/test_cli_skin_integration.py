...
from korra_cli.skin_engine import get_active_skin, set_active_skin
...
class TestCliSkinPromptIntegration:
    ...
    def test_handle_skin_command_refreshes_live_tui(self, capsys):
        ...
        assert "Выбрана тема: ares (сохранено)" in output
        assert "Цвета ввода и TUI обновлены." in output
        assert cli._app.style is not None
