...
def test_no_unreviewed_bare_managed_runtime_lookups():
    ...
    assert not unexpected, (
        ...
        "  node/npm -> korra_constants.find_node_executable()\n"
        "  PATH env -> korra_constants.iter_hermes_node_dirs()\n"
...
def test_managed_node_helpers_exist(helper):
    ...
    assert callable(getattr(korra_constants, helper))


def test_managed_uv_helpers_exist():
    from korra_cli.managed_uv import ensure_uv, managed_uv_path, resolve_uv
