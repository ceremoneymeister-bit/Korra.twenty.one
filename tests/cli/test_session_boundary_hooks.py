...
from korra_cli.plugins import VALID_HOOKS, PluginManager
...
# tests/korra_cli/test_lifecycle.py::test_finalize_session_closes_core_before_plugin_export.
@patch("korra_cli.lifecycle.invoke_hook")
@patch("korra_cli.lifecycle.finalize_session")
...
@patch("korra_cli.plugins.invoke_hook")
