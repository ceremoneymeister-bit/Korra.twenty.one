"""Tests for _setup_feishu() in korra_cli/gateway.py.
...
def _run_setup_feishu(
    *,
    ...
    with patch("korra_cli.config.save_env_value", side_effect=mock_save), \
         patch("korra_cli.config.get_env_value", side_effect=mock_get), \
         patch("korra_cli.config.remove_env_value", side_effect=mock_remove), \
         patch("korra_cli.cli_output.prompt_yes_no", side_effect=prompt_yes_no_responses), \
         patch("korra_cli.setup.prompt_choice", side_effect=prompt_choice_responses), \
         patch("korra_cli.cli_output.prompt", side_effect=prompt_responses), \
         patch("korra_cli.cli_output.print_header"), \
         patch("korra_cli.cli_output.print_info"), \
         patch("korra_cli.cli_output.print_success"), \
         patch("korra_cli.cli_output.print_warning"), \
         patch("korra_cli.cli_output.print_error"), \
