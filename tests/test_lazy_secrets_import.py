...
assert 'korra_cli.secrets_cli' not in sys.modules, \\
...
"""
    ...
    def test_update_check_no_cryptography(self) -> None:
        ...
        # Write a small script in the repo root so korra_cli is importable,
...
import korra_cli.main
from korra_cli.update_cmd import _cmd_update_check
