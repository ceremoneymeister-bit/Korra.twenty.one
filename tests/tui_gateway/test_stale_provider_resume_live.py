...
def live_home(monkeypatch):
    ...
    # korra_constants caches the resolved home at first read — the env var
    ...
    import korra_cli.config as hconfig
    ...
    # conftest also re-pins korra_state.DEFAULT_DB_PATH per test; pin it to
