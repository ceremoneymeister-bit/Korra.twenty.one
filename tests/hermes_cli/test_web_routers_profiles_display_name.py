...
from hermes_cli.profiles import create_profile, get_profile_dir, read_profile_meta
...
def _call(name, display_name):
    from hermes_cli.web_models import ProfileDisplayNameUpdate
    from hermes_cli.web_routers.profiles import update_profile_display_name_endpoint
