...
command replies, restart-drain notices, and concise provider-failure guidance.
Agent-generated output, log lines, raw provider diagnostics, tool outputs, and
slash-command descriptions are not translated.
...
pt, ru, hu, ar.  Unknown language values fall back to Russian. Missing catalog keys fall back to English.
"""
