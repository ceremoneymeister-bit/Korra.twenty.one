...
from hermes_constants import get_config_path, get_skills_dir, is_termux, korra_env
...
def _detect_environment(env: str) -> bool:
    ...
    if env == "kanban":
        ...
        # tool availability.
        if korra_env("HERMES_KANBAN_TASK") or korra_env("HERMES_KANBAN_BOARD"):
