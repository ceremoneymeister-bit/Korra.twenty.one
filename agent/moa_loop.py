...
def _moa_privacy_mode(moa_raw: Any) -> str:
    ...
    from korra_cli.moa_config import coerce_privacy_filter
...
def aggregate_moa_context(
    *,
    ...
    synth_prompt = (
        ...
        "Korra agent. Focus on next steps, tool-use strategy, risks, and any "
    ...
    return (
        ...
        "normal Korra agent loop. You may call tools, continue reasoning, or "
        "finish normally.]\n"
